...
const Project = ({mainFocus, title, img, top, topLumina, projectName, stack, intro, description, image1, image2, image3, image4, repo, link, next}) => {
  const width = window.innerWidth <= 768

  return (
    <div className='projectDiv'>
      <p className='main-focus'>{mainFocus}</p>
      <p className='title'><LuStars className='star'/><span style={{textAlign: 'center'}}> {title} </span> <LuStars className='star' /></p>
      ...
      <div className='projectDescription'>
        ...
        <div className='descriptionDiv'>
          <h3 className='description' style={{position: 'relative', top: top, left: '30px', fontSize: '25px'}}>Description</h3>
      ...
      <a href={repo} className='projectLink'>Github <FaGithub style={{position: 'relative', top: '5px', fontSize: '25px'}} /></a>
      <a href={link} className='projectLink'>Live<MdOutlineRadar style={{position: 'relative', top: '5px', fontSize: '25px', marginLeft: '5px'}} /></a>
