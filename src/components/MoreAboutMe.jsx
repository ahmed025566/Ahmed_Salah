    ...
    return (
        ...
        <div className='more-information-wraper' ref={wraper}>
            ...
            <div id="aboutMePara" data-aos="zoom-in">
                ...
                <p className='about-me-paragraph'>I am passionate about using technology to create
                    ...
                    communicator and I am able to translate technical concepts into clear and concise language.</p>
            </div>
            ...
            <div className='detailed-education'>
                ...
                <div className='Div' data-aos="zoom-in-left">
                    ...
                    <ul className='job description'>
                        <li className='item'>My studies in business administration have given me a strong understanding of
                            ...
                            goals that web applications are designed to achieve.</li>
                        <li className='item'>This knowledge has helped me to understand the needs of my clients and to
