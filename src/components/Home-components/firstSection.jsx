...
const FirstSection = () => (
  <section className="first-section">
    ...
    <MoreAbout />
    <NavLink to="works">
      <div className="show-them-projects" data-aos="zoom-in">
...
export const MoreAbout = ({
  id, top, width, left, GetInLeft,
}) => (
  <NavLink to="/more-about-me">
    <div className="more-about-me" style={{ top, width, left }} data-aos="zoom-in" id={id}>
