  ...
  return (
    ...
    <div className='conatcWrapper'>
        ...
        <form className='conatctForm' onSubmit={handleSubmit}>
            ...
            <input type='text' ref={Name} name="user_name" placeholder='Name *' className='formItem' required></input>
            <input type="email" ref={Email} name="user_mail" placeholder='Email *' className='formItem' required></input>
            <input type='text' ref={Subject} name="user_message" placeholder='Your Subject *' className='formItem' required></input>
            <textarea placeholder='Your Message' ref={Message} className='textArea formItem' required rows="8" maxLength="1000"></textarea>
